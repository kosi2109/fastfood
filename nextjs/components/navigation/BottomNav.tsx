...
const classN = "w-1/4 cursor-pointer flex items-center justify-center flex-col";
const active = "w-1/4 cursor-pointer text-textGreen flex items-center justify-center flex-col";
